<template>
  <div>
      ...
      <div v-else class="flex ml-5 w-6 text-red-500">
        <h3>Если Вы видите это сообщение, значит сервер, на котором хранятся демонстрационные материалы, в данный момент перегружен запросами или недоступен. Попробуйте зайти позже.</h3>
      </div>
  </div>
</template>
